...
function getErrorPopup(message: string) {
  ...
  if (message.includes('COMPANY_DELETED') || message.includes('removed from the platform')) {
    return { icon: '🗑️', title: 'Company Account Deleted', message: 'Your company account has been permanently deleted by the platform administrator. Please contact support.', color: 'red' };
  }
  ...
  if (message.includes('Invalid credentials')) {
    return { icon: '🔑', title: 'Invalid Credentials', message: 'Your email or password is incorrect. If your password was recently reset by the platform administrator, please use the new password. Contact support if you need help.', color: 'blue' };
  }
  return null;
}
